                    ...
                    <form>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-1">
                                ...
                                <div class="input-group">
                                    <button type="button" wire:click='default' data-toggle="modal"
                                        data-target=".createCompanyAso"
                                        class="btn btn-info btn-lg btn-block btn-sm mt-0">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="name" wire:model='post' class="form-control"
                                    placeholder="Função">
                                @error('post')
                                    <span class="badge badge-danger mt-2" style="font-size: 11px">{{ $message }}</span>
                                @enderror
